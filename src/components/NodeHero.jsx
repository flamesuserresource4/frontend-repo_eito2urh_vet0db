    ...
    <section className="relative w-full h-[80vh] min-h-[620px] bg-black overflow-hidden">
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-6 md:px-10 flex items-center">
        <div className="max-w-3xl">
          <p className="uppercase tracking-widest text-xs md:text-sm text-white/60">OREON AI • Whitelist Access</p>
          <h1 className="mt-2 text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
            Own a Node. Secure the Network. Earn Rewards.
          </h1>
          <p className="mt-4 md:mt-6 text-white/80 text-base md:text-lg">
            Join the OREON AI whitelist round for early supporters. Each node acts as a validator and earns daily rewards.
